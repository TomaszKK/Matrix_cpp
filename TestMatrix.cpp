...
void testReferenceCounting(Matrix&, const Matrix&);
...
int main()
{
    try {
        ...
        testReadandWrite(A);
        cout << endl
             << "Value of Referece Counting of A before passing to function = "
             << (A.getrefcount()) << endl;
...
void testReferenceCounting(Matrix& A, const Matrix& B)
{
    cout << endl << "--- Test Reference Counting ---" << endl << endl;
    cout << "Reference Count of A before creat C(A) = " << (A.getrefcount())
         << endl;
    cout << "Copy A to C" << endl;
    Matrix C(A);
    cout << "Reference Count of A = " << (A.getrefcount()) << endl;
    cout << "Reference Count of C = " << (C.getrefcount()) << endl;
}

void testException(const Matrix& A, const Matrix& B, const Matrix& C,
                   const Matrix& D)
{
